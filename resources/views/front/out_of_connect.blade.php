    ...
    <body class="font-poppins text-[#030303] bg-[#F6F5FA] pb-[100px] px-4 sm:px-0">
        ...
        <div
            ...
            <div class="flex items-center w-[380px] gap-3 text-center">
                <a href="https://wa.me/6285155344998?text=saya%20mau%20top%20up%20connect"
                    class="p-[14px_20px] rounded-full bg-[#6635F1] font-semibold text-white w-full">Contact
                    CS</a>
            </div>
        </div>
    </body>
