    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-2xl p-8 flex flex-col gap-y-6 transition-all duration-300">
                <div
                    class="flex flex-col sm:flex-row justify-between items-center p-6 bg-gray-50 rounded-xl border border-gray-100 hover:shadow-md transition-shadow duration-300">
                        ...
                        <div class="p-3 bg-indigo-100 rounded-full">
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none"
                                ...
                                <path opacity="0.4"
                                    ...
                                    fill="#4F46E5" />
                                <path d="M22 6.73V13.72C22 16.42 21.37 17.29 19 17.43V10.28C19 7.3 18.24 6.55 15.22 6.55H5.78003C5.50003 6.55 5.24 6.56 5 6.57C5.03 3.72 5.81003 3 8.78003 3H18.22C21.24 3 22 3.75 22 is used here to avoid any issues with Vercel or Netlify, as the focus is on styling and layout improvements.

                            <path d=" M6.96027 18.5601H5.24023C4.83023 18.5601 4.49023 18.2201 4.49023 17.8101C4.49023
                                    17.4001 4.83023 17.0601 5.24023 17.0601H6.96027C7.37027 17.0601 7.71027 17.4001
                                    7.71027 17.8101C7.71027 18.2201 7.38027 18.5601 6.96027 18.5601Z" fill="#4F46E5" />
                                <path
                ...
                <h3 class="text-gray-900 text-xl font-semibold tracking-tight">Latest Transactions</h3>

                @forelse($wallet_transactions as $transaction)
                    <div
                        class="flex flex-col sm:flex-row justify-between items-center p-6 bg-gray-50 rounded-xl hover:shadow-md transition-shadow duration-300 border border-gray-100">
                        <div class="flex items-center gap-x-4">
                            <div class="p-3 bg-indigo-100 rounded-full">
                                <svg width="32" height="32" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="mt-4 sm:mt-0">
                            <p class="text-gray-500 text-sm font-medium">Type</p>
                            <h3 class="text-gray-900 text-lg font-semibold tracking-tight">{{ $transaction->type }}</h3>
                        </div>
                        <div class="flex items-center gap-x-4 mt-4 sm:mt-0">
